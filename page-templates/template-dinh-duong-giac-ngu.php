...
<body class="bg-sleep-50 text-sleep-800 font-sans antialiased overflow-x-hidden">
    <header class="bg-white border-b border-sleep-200 py-16 px-6 sm:px-12 lg:px-24">
        <div class="max-w-5xl mx-auto text-center fade-in">
            <div
                class="inline-block bg-indigo-100 text-indigo-700 px-5 py-1.5 rounded-full text-sm font-bold mb-6 tracking-wide shadow-sm uppercase">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-sleep-800 mb-6 leading-tight">
                ...
                <span class="text-2xl md:text-3xl lg:text-4xl text-sleep-600 font-heading mt-2 block">Giúp Trẻ Tự Kỷ Tìm
                    Lại Giấc Ngủ Ngon</span>
            </h1>
            <p
                class="text-lg md:text-xl text-sleep-600 max-w-3xl mx-auto leading-relaxed mt-8 bg-sleep-50 p-6 rounded-2xl border border-sleep-100 shadow-sm">
                Giấc ngủ của trẻ không tự nhiên mà có. Nó là kết quả của một chuỗi phản ứng sinh hóa phức tạp bắt đầu từ
                <strong>Đường ruột</strong>. Ở trẻ tự kỷ, viêm ruột và loạn khuẩn làm cạn kiệt Serotonin (Hormone hạnh
                phúc) và Melatonin (Hormone giấc ngủ). Thay vì dùng thuốc an thần, ba mẹ hoàn toàn có thể cung cấp
                nguyên liệu sinh học từ bữa ăn tối để cơ thể con tự sản xuất lại giấc ngủ.
            </p>
        </div>
    </header>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="mb-12 text-center fade-in">
                ...
                <p class="text-sleep-600 max-w-2xl mx-auto">
                    Khu vực này trình bày 3 quy tắc y sinh học cốt lõi. Hiểu rõ cơ chế "Mở đường", "Kẻ cắp giấc ngủ" và
                    "Nhịp sinh học" sẽ giúp ba mẹ tạo nền tảng vững chắc để não bộ tự tổng hợp hormone. Rê chuột vào
                    từng thẻ để xem chi tiết cơ chế hoạt động.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all-custom border-t-4 border-indigo-500 group flex flex-col h-full cursor-default fade-in"
                    style="animation-delay: 0.1s;">
                    <div
                        class="text-5xl mb-6 bg-indigo-50 w-20 h-20 flex items-center justify-center rounded-2xl group-hover:scale-110 transition-transform">
                        🧠</div>
                    <h3
                        class="text-xl font-heading font-bold text-sleep-800 mb-3 group-hover:text-indigo-600 transition-colors">
                        1. "Mở đường" lên NÃO</h3>
                    <p class="text-sleep-600 mb-4 font-bold text-sm bg-sleep-100 p-2 rounded-lg text-center">Thịt/Trứng
                        + Tinh bột chậm</p>
                    <p class="text-sleep-600 text-base leading-relaxed flex-grow">
                        Để tạo ra Serotonin, cơ thể cần <strong>Tryptophan</strong>. Tuy nhiên, Tryptophan rất khó đi
                        lên não nếu đi một mình. Luôn kết hợp với tinh bột hấp thu chậm. Tinh bột sẽ dọn dẹp các rào cản
                        trong máu, mở ra "con đường thênh thang" đưa Tryptophan tiến thẳng lên não bộ.
                    </p>
                </div>

                <div class="bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all-custom border-t-4 border-red-500 group flex flex-col h-full cursor-default fade-in"
                    style="animation-delay: 0.2s;">
                    <div
                        class="text-5xl mb-6 bg-red-50 w-20 h-20 flex items-center justify-center rounded-2xl group-hover:scale-110 transition-transform">
                        🚫</div>
                    <h3
                        class="text-xl font-heading font-bold text-sleep-800 mb-3 group-hover:text-red-600 transition-colors">
                        2. Tránh "KẺ CẮP GIẤC NGỦ"</h3>
                    <p class="text-sleep-600 mb-4 font-bold text-sm bg-red-50 p-2 rounded-lg text-red-700 text-center">
                        Không đường / Màu / MSG</p>
                    <p class="text-sleep-600 text-base leading-relaxed flex-grow">
                        Bữa tối tuyệt đối không chứa đường tinh luyện, nước ngọt, màu nhân tạo hay bột ngọt (MSG). Những
                        chất này gây kích thích thần kinh quá mức, làm não bộ "căng như dây đàn", khiến con tăng động và
                        phá vỡ hoàn toàn cấu trúc giấc ngủ.
                    </p>
                </div>

                <div class="bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all-custom border-t-4 border-calm-DEFAULT group flex flex-col h-full cursor-default fade-in"
                    style="animation-delay: 0.3s;">
                    <div
                        class="text-5xl mb-6 bg-calm-light w-20 h-20 flex items-center justify-center rounded-2xl group-hover:scale-110 transition-transform">
                        ⏰</div>
                    <h3
                        class="text-xl font-heading font-bold text-sleep-800 mb-3 group-hover:text-calm-dark transition-colors">
                        3. Tuân thủ NHỊP SINH HỌC</h3>
                    <p
                        class="text-sleep-600 mb-4 font-bold text-sm bg-calm-light p-2 rounded-lg text-calm-dark text-center">
                        Ăn trước ngủ 2 - 2.5 tiếng</p>
                    <p class="text-sleep-600 text-base leading-relaxed flex-grow">
                        Khi đi ngủ, toàn bộ năng lượng của cơ thể cần được dồn vào việc phục hồi não bộ và sửa chữa tế
                        bào. Nếu ăn quá muộn, cơ thể phải gồng mình tiêu hóa thức ăn trong dạ dày, con sẽ rất khó có
                        được một giấc ngủ sâu.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 px-6 sm:px-12 lg:px-24 bg-white border-y border-sleep-200 relative overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-full bg-sleep-50 opacity-50 transform -skew-y-3 origin-top-left z-0">
        </div>
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="mb-12 text-center fade-in">
                <h2 class="text-3xl font-heading font-bold text-sleep-800 mb-4">📍 4 nhóm Thực phẩm "Cây nhà lá vườn"
                </h2>
                <p class="text-sleep-600 max-w-2xl mx-auto">
                    Khu vực này giúp ba mẹ hình dung tỷ lệ của một bữa ăn an thần. Không cần tìm kiếm đâu xa, thuốc an
                    thần tự nhiên tốt nhất nằm ở 4 nhóm chất này. Nhấp vào các phần của biểu đồ để xem chức năng sinh
                    học chi tiết của từng loại thực phẩm.
                </p>
            </div>

            <div class="flex flex-col lg:flex-row items-center gap-12 bg-white p-8 rounded-3xl shadow-lg border border-sleep-100 fade-in"
                style="animation-delay: 0.2s;">
                <div class="w-full lg:w-5/12">
                    ...
                    <p class="text-xs text-center text-sleep-500 mt-6">*Tỷ lệ trên mang tính minh họa cho sự đa dạng cần
                        thiết, không phải định lượng tuyệt đối.</p>
                </div>

                <div class="w-full lg:w-7/12">
                    <div id="food-detail-panel"
                        class="bg-sleep-50 p-8 rounded-2xl h-full flex flex-col justify-center min-h-[350px] transition-all-custom border-l-4 border-indigo-500">
    ...
    <section class="py-20 px-6 sm:px-12 lg:px-24 bg-sleep-50">
        <div class="max-w-5xl mx-auto">
            <div class="mb-12 text-center fade-in">
                ...
                <p class="text-sleep-600 max-w-2xl mx-auto">
                    Phần này là công cụ thực hành hằng ngày. Chúng tôi đã thiết kế sẵn 4 thực đơn kết hợp chuẩn xác các
                    nhóm thực phẩm trên. Ba mẹ hãy nhấp vào các tab dưới đây để khám phá các mâm cơm tối nay.
                </p>
            </div>

            <div class="flex overflow-x-auto space-x-3 pb-4 mb-8 justify-start md:justify-center no-scrollbar fade-in"
                id="menu-nav" style="animation-delay: 0.1s;">
            </div>

            <div id="menu-display"
                class="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-sleep-100 min-h-[350px] flex flex-col justify-center transition-all-custom relative overflow-hidden fade-in"
                style="animation-delay: 0.2s;">
            </div>

            <div class="mt-8 bg-warm-light border border-warm-DEFAULT rounded-xl p-4 flex items-start gap-4 max-w-3xl mx-auto fade-in"
                style="animation-delay: 0.3s;">
                <span class="text-2xl mt-1">👨‍🍳</span>
                <p class="text-sm text-sleep-700 leading-relaxed font-medium">
                    <strong>Lời khuyên chế biến:</strong> Ba mẹ hãy luân phiên thay đổi 4 thực đơn này trong tuần. Ưu
                    tiên các phương pháp chế biến giữ nguyên dưỡng chất như luộc, hấp, áp chảo. Tuyệt đối hạn chế chiên
                    xào sử dụng nhiều dầu mỡ công nghiệp.
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="environment-section"
        class="py-24 px-6 sm:px-12 lg:px-24 bg-white transition-colors duration-1000 ease-in-out">
        <div class="max-w-4xl mx-auto text-center relative z-10">
            <h2 id="env-title"
                class="text-3xl font-heading font-bold text-sleep-800 mb-6 transition-colors duration-1000">💡 Lưu ý
                QUAN TRỌNG về môi trường</h2>
            <p id="env-desc" class="text-sleep-600 mb-10 text-lg transition-colors duration-1000 max-w-2xl mx-auto">
                Dinh dưỡng đúng kết hợp với môi trường êm dịu sẽ là chiếc nôi hoàn hảo. Yếu tố quyết định cuối cùng nằm
                ở ánh sáng. <strong>Hãy thử thao tác công tắc dưới đây để khám phá bí mật của cơ thể.</strong>
            </p>

            <button id="toggle-light-btn"
                class="bg-sleep-800 text-white hover:bg-black font-bold py-4 px-10 rounded-full shadow-lg transition-all-custom transform hover:scale-105 flex items-center justify-center mx-auto gap-3 text-lg focus:outline-none focus:ring-4 focus:ring-sleep-300">
                <span id="btn-icon" class="text-2xl">🌙</span> <span id="btn-text">Tắt đèn PHÒNG NGỦ</span>
            </button>

            <div id="melatonin-secret"
                class="mt-16 opacity-0 translate-y-10 h-0 overflow-hidden transition-all duration-1000 ease-in-out">
                <div
                    class="bg-sleep-800/80 backdrop-blur-md text-sleep-100 p-8 md:p-10 rounded-3xl border border-sleep-600 text-left shadow-2xl">
                    <h3
                        class="text-2xl font-heading font-bold text-warm-DEFAULT mb-6 flex items-center gap-3 border-b border-sleep-600 pb-4">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4 bg-sleep-900/50 p-4 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-sleep-300">Hormone giấc ngủ Melatonin không thể giải phóng nếu có ánh
                                    sáng. Tuyệt đối không cho con xem Tivi, iPad hay điện thoại sau bữa tối vì ánh sáng
                                    xanh sẽ phá hủy toàn bộ nỗ lực dinh dưỡng của bạn.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4 bg-sleep-900/50 p-4 rounded-xl">
                            <span class="text-3xl">🎵</span>
                            <div>
                                ...
                                <p class="text-sleep-300">Hãy giảm sáng đèn phòng, bật một bản nhạc không lời tần số
                                    thấp (nhạc sóng não) để báo hiệu cho hệ thần kinh giao cảm được nghỉ ngơi.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4 bg-sleep-900/50 p-4 rounded-xl">
                            <span class="text-3xl">🛁</span>
                            <div>
                                ...
                                <p class="text-sleep-300">Một mẹo nhỏ: Cho con ngâm mình trong chậu nước ấm pha chút
                                    muối Epsom. Muối này chứa Magie Sulfate thẩm thấu rất tốt qua da, giúp thư giãn bó
                                    cơ cực kỳ hiệu quả.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer
        class="bg-sleep-900 text-sleep-300 py-20 px-6 sm:px-12 text-center border-t-8 border-indigo-600 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto relative z-10">
            <h2 class="text-3xl font-heading font-bold text-white mb-6">ĐỂ ĐƯỢC TƯ VẤN DINH DƯỠNG CÁ NHÂN HÓA CHO TỪNG
                BÉ</h2>
            <p class="mb-10 text-lg leading-relaxed max-w-2xl mx-auto text-sleep-200">
                Mỗi em bé là một cá thể riêng biệt với tình trạng đường ruột và cơ địa khác nhau. Để xây dựng lộ trình
                dinh dưỡng và can thiệp sinh học phù hợp nhất cho con mình, ba mẹ vui lòng liên hệ:
            </p>
            ...
            <div
                class="flex flex-col md:flex-row justify-center gap-8 text-base font-semibold bg-sleep-800 p-6 rounded-2xl inline-flex flex-wrap shadow-inner">
            ...
            <div class="mt-16 pt-8 border-t border-sleep-700/50">
                <p class="text-xl font-heading font-bold text-calm-light italic leading-relaxed">
                    "Một đêm ngon giấc không chỉ xoa dịu hệ thần kinh đang quá tải, mà còn là chìa khóa vàng giúp não bộ
                    tự chữa lành và mở ra cơ hội phục hồi toàn diện cho con."
                </p>
            </div>
        </div>
    </footer>
