    ...
    <section class="bg-navy py-24 md:py-32 px-6">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <a href="https://hieucontugoc.online/bang-kiem-tra-suc-khoe-toan-dien/"
                class="bg-yellow text-navy font-bold px-8 py-4 rounded-full shadow-lg hover:scale-105 hover:shadow-xl transition-all block w-fit mx-auto text-lg uppercase tracking-wide">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <p class="text-center font-quicksand text-text-soft text-lg max-w-3xl mx-auto mb-16">
                Nhiều cha mẹ thường thắc mắc tại sao các vấn đề về <a
                    ...
                    class="text-navy font-bold hover:underline">tiêu hóa dạ dày trẻ tự kỷ</a> lại phổ biến và nghiêm
                ...
                <div class="bg-cream p-8 rounded-2xl shadow-sm">
                    ...
                    <p class="font-quicksand text-text-dark leading-relaxed">
                        ...
                        trọng. Cha mẹ có thể tìm hiểu thêm về hiện tượng <a
                            ...
                            class="text-navy font-bold hover:underline">dysbiosis đường ruột ở trẻ tự kỷ</a> để hiểu rõ
                        hơn.
                        <br><br>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-md">
                    ...
                    <p class="font-quicksand text-text-dark leading-relaxed">
                        ...
                        Điều này cũng xảy ra ở các thái cực đối lập, ví dụ như khi <a
                            ...
                            class="text-navy font-bold hover:underline">trẻ tự kỷ táo bón mãn tính</a>. Sự ách tắc và
    ...
    <section class="bg-white py-16 md:py-24 px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-12">
                ...
                <p class="font-quicksand text-text-dark leading-relaxed bg-cream p-6 rounded-xl border-l-4 border-navy">
                    ...
                    Nhiều gia đình đã ghi nhận những cải thiện tích cực khi áp dụng <a
                        ...
                        class="text-navy font-bold hover:underline">chế độ ăn không gluten casein (gfcf) cho trẻ tự
            ...
            <div class="text-center">
                ...
                <p class="mt-4 font-quicksand text-text-soft text-sm">Hành động nhỏ của cha mẹ có thể xoa dịu nỗi đau vô
                    hình của con.</p>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="space-y-4">
                <details class="group bg-white rounded-xl shadow-sm">
                    <summary
                        class="font-oswald text-navy text-lg p-6 cursor-pointer font-semibold flex justify-between items-center">
                ...
                <details class="group bg-white rounded-xl shadow-sm">
                    ...
                    <div class="px-6 pb-6 text-text-dark font-quicksand">
                        ...
                        nhìn vào triệu chứng tiêu chảy. Cha mẹ hãy dành vài phút để hoàn thành <a
                            ...
                            class="text-navy font-bold hover:underline">bảng kiểm tra sức khỏe toàn diện</a> nhằm giúp
