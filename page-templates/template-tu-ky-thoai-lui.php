...
<body class="bg-purple-50 antialiased overflow-x-hidden">
            ...
            <div class="md:flex">
                <div class="md:w-1/2 p-8 md:p-12 bg-purple-900 text-white flex flex-col justify-center">
                    ...
                    <p class="mb-4 text-purple-100 leading-relaxed">
                        Khoảng <strong class="text-white text-xl">30%</strong> trẻ em mắc Phổ Tự Kỷ (ASD) trải qua hội chứng <em>thoái lui phát triển</em> (Developmental Regression). 
                    </p>
                ...
                <div class="md:w-1/2 p-8 md:p-12">
                    ...
                    <div class="relative border-l-2 border-brand ml-4 space-y-8">
                        ...
                        <div class="relative pl-6">
                            ...
                            <p class="text-text-muted text-sm mt-1">Sự phát triển chững lại. Trẻ đột ngột đánh mất các kỹ năng ngôn ngữ và giao tiếp xã hội đã có.</p>
                        </div>
                        <div class="relative pl-6">
                            ...
                            <p class="text-text-muted text-sm mt-1">Xuất hiện các hành vi rập khuôn, lặp đi lặp lại. Trẻ thu mình và giảm tương tác.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-brand-light px-4 relative overflow-hidden">
        <div class="max-w-6xl mx-auto text-center relative z-10 fade-in-up">
            ...
            <p class="text-text-muted max-w-2xl mx-auto mb-16 text-lg">Ruột và não không hoạt động độc lập. Chúng liên lạc liên tục với nhau thông qua mạng lưới thần kinh và hóa học.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-md relative infographic-line">
                    ...
                    <p class="text-sm text-text-muted">Cầu nối thần kinh chủ đạo (Vagus Nerve) dẫn truyền tín hiệu song hướng liên tục mỗi giây giữa hệ tiêu hóa và não bộ.</p>
                </div>
        ...
        <div class="space-y-12">
            ...
            <div class="flex flex-col md:flex-row items-center bg-white p-6 md:p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition duration-300 fade-in-up">
                ...
                <div class="md:w-2/3 md:pl-8">
                    <h3 class="text-2xl font-bold text-slate-800 mb-3">1. Hội chứng Rò rỉ ruột & Suy yếu rào cản não</h3>
            ...
            <div class="flex flex-col md:flex-row-reverse items-center bg-white p-6 md:p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition duration-300 fade-in-up delay-100">
                ...
                <div class="md:w-2/3 md:pr-8">
                    ...
                    <div class="bg-orange-50 border-l-4 border-orange-500 p-3 text-sm text-orange-800 rounded">
                        <strong>Hậu quả:</strong> Microglia "cắt tỉa" nhầm cả những kết nối thần kinh (synapse) khỏe mạnh phụ trách ngôn ngữ và giao tiếp, khiến kỹ năng đột ngột biến mất.
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center bg-white p-6 md:p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition duration-300 fade-in-up delay-200">
                ...
                <div class="md:w-2/3 md:pl-8">
                    ...
                    <div class="bg-slate-100 border-l-4 border-slate-500 p-3 text-sm text-slate-800 rounded">
                        <strong>Hậu quả:</strong> Não bộ buộc phải "tắt" hoặc đình trệ các khu vực đòi hỏi năng lượng cao (như nhận thức, ngôn ngữ học hỏi) để duy trì chức năng sinh tồn.
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-purple-900 text-white px-4">
        <div class="max-w-5xl mx-auto fade-in-up">
            <div class="text-center mb-12">
                ...
                <p class="text-purple-200 text-lg">Trẻ tự kỷ thoái lui có nguy cơ mắc bệnh tiêu hóa cao hơn đáng kể. Vì rào cản ngôn ngữ, hãy chú ý các hành vi phi ngôn ngữ sau:</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-purple-800 p-6 rounded-2xl border border-purple-700 hover:border-accent transition duration-300">
                    ...
                    <h3 class="text-xl font-bold mb-2">Rối loạn bài tiết</h3>
                ...
                <div class="bg-purple-800 p-6 rounded-2xl border border-purple-700 hover:border-accent transition duration-300">
                    ...
                    <p class="text-purple-200 text-sm">Khó vào giấc hoặc giật mình thức giấc hoảng loạn giữa đêm (do các cơn co thắt cơ trơn ruột).</p>
                </div>
                ...
                <div class="bg-purple-800 p-6 rounded-2xl border border-purple-700 hover:border-accent transition duration-300 lg:col-span-2">
                    ...
                    <p class="text-purple-200 text-sm">Từ chối thức ăn mới, chỉ ăn một nhóm thức ăn nhất định (thường là chế phẩm nhiều carbohydrate, tinh bột trắng, ít chất xơ).</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden fade-in-up">
            ...
            <div class="p-8 md:p-10">
                <p class="text-center text-text-muted mb-10 max-w-3xl mx-auto">
                    Thông qua việc phối hợp cùng bác sĩ nhi khoa, bác sĩ tiêu hóa và chuyên gia dinh dưỡng lâm sàng, cha mẹ có thể định hướng can thiệp phục hồi "khu rừng" đường ruột cho con bằng 3 trụ cột:
                </p>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-text-muted">Hạn chế carbohydrate tinh chế, đồ ăn chế biến công nghiệp. Tăng cường chất xơ hòa tan tự nhiên phù hợp dung nạp.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-text-muted">Ứng dụng chủng vi sinh vật có lợi đặc hiệu cho trục ruột - não (psychobiotics) dưới sự tư vấn y khoa để ức chế hại khuẩn.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="font-bold text-slate-800 text-lg mb-2">3. Điều trị y khoa chuyên sâu</h4>
                        <p class="text-sm text-text-muted">Can thiệp dứt điểm các tình trạng viêm nhiễm, táo bón mãn tính để phục hồi tính toàn vẹn của hàng rào niêm mạc ruột.</p>
                    </div>
                </div>
                ...
                <div class="mt-12 bg-accent-light p-6 rounded-2xl border border-accent border-opacity-30 text-center">
                    <p class="text-slate-800 font-medium italic">
                        "Khi hệ tiêu hóa bình ổn, rào cản ruột phục hồi, bão viêm thần kinh sẽ dịu đi. Não bộ sẽ có môi trường an toàn và dồi dào năng lượng để tái cấu trúc nơ-ron, giúp con dần phục hồi kỹ năng."
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gradient-to-br from-brand-dark to-brand rounded-3xl shadow-2xl p-10 md:p-14 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-brand-light text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
                        Mỗi đứa trẻ là một cá thể độc lập với hệ vi sinh đường ruột và tình trạng phát triển hoàn toàn khác nhau. Đừng ngần ngại liên hệ với chuyên gia <strong>Helen Hoai</strong> để được lắng nghe và tư vấn lộ trình hỗ trợ phù hợp nhất cho bé yêu nhà bạn.
                    </p>
    ...
    <footer class="bg-purple-950 text-purple-300 py-10 px-4 text-center text-sm">
        <div class="max-w-4xl mx-auto">
            ...
            <h4 class="font-bold text-purple-200 mb-2 uppercase tracking-wider">Tuyên bố miễn trừ trách nhiệm y tế</h4>
            <p class="mb-4">
                Trang web này được thiết kế nhằm mục đích cung cấp kiến thức y khoa tổng quan dựa trên các nghiên cứu khoa học hiện hành về Trục ruột - Não và Phổ Tự Kỷ. Các thông tin này <strong>không</strong> thay thế cho chẩn đoán y khoa, tư vấn chuyên môn hay phác đồ điều trị của bác sĩ.
            </p>
            <p>
                Mọi quyết định can thiệp về y tế, sử dụng thực phẩm chức năng, men vi sinh hay thay đổi chế độ dinh dưỡng lâm sàng cho bệnh nhi cần được thực hiện dưới sự tham vấn và giám sát chặt chẽ của các chuyên gia y tế chuyên ngành.
            </p>
            <div class="mt-8 border-t border-purple-800 pt-8">
                <p>&copy; 2026 Awareness Project - Hành trình đồng hành cùng trẻ tự kỷ.</p>
            </div>
        </div>
    </footer>
