 ...
 */
?>
    <footer id="colophon" class="bg-gradient-to-b from-navy to-[#0A1121] text-white pt-20 pb-8 mt-12 relative overflow-hidden">
        ...
        <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-12 lg:gap-16 mb-16">
                ...
                <div class="xl:col-span-4 flex flex-col">
                    <h2 class="font-serif text-2xl md:text-3xl font-bold mb-6 text-white flex items-center gap-3">
                        <i data-lucide="leaf" class="w-8 h-8 text-secondary"></i>
                        Hiểu Con Từ Gốc
                    </h2>
                    <p class="text-white/80 text-lg leading-relaxed mb-6 italic border-l-4 border-secondary/60 pl-4">
                    ...
                    <div class="flex gap-4 mt-auto">
                        <a href="https://www.facebook.com/groups/tukylaroiloantoanthan" target="_blank" rel="noopener" aria-label="Facebook" class="w-10 h-10 rounded-full bg-white/10 hover:bg-secondary flex items-center justify-center transition-colors border border-white/20 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                        </a>
                        <a href="https://www.youtube.com/@hieucontugoc?sub_confirmation=1" target="_blank" rel="noopener" aria-label="Youtube" class="w-10 h-10 rounded-full bg-white/10 hover:bg-secondary flex items-center justify-center transition-colors border border-white/20 text-white">
                ...
                <div class="xl:col-span-4">
                    <h3 class="font-serif text-xl font-bold mb-6 text-white border-b border-white/10 pb-3">Tự Kỷ Là Rối Loạn Toàn Thân</h3>
                    <ul class="space-y-4 text-white/70 text-sm">
                        <li class="flex items-start gap-3">
                            <i data-lucide="brain-circuit" class="w-5 h-5 text-secondary shrink-0 mt-0.5"></i>
                            <p>Khoa học chứng minh não bộ không hoạt động biệt lập. Những khó khăn của con là hệ quả từ sự rối loạn hệ thống.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <i data-lucide="activity" class="w-5 h-5 text-secondary shrink-0 mt-0.5"></i>
                            <p>Đường ruột tổn thương, miễn dịch suy yếu và gánh nặng độc tố trực tiếp ngăn cản sự phát triển nhận thức.</p>
                        </li>
                        <li class="flex items-start gap-3">
                            <i data-lucide="puzzle" class="w-5 h-5 text-secondary shrink-0 mt-0.5"></i>
                ...
                <div class="xl:col-span-4 bg-white/5 rounded-3xl p-6 border border-white/10">
                    <h3 class="font-serif text-xl font-bold mb-4 text-white">Trụ Cột Kiến Thức</h3>
                    <div class="flex flex-wrap gap-2 mb-6 text-[12px] font-medium text-navy">
                        <span class="bg-secondary/90 px-3 py-1 rounded-full">Trục Não - Ruột</span>
                        <span class="bg-secondary/90 px-3 py-1 rounded-full">Dinh dưỡng trị liệu</span>
                        <span class="bg-secondary/90 px-3 py-1 rounded-full">Giải độc tố</span>
                        <span class="bg-secondary/90 px-3 py-1 rounded-full">Y sinh (Biomedical)</span>
                    </div>
                    
                    <p class="text-white/80 text-sm leading-relaxed mb-6">
                        Xây dựng cộng đồng cha mẹ hiểu biết, không phó mặc. Trở thành "người bác sĩ" tốt nhất của con dựa trên nền tảng khoa học thực chứng: <strong class="text-secondary italic">"Cơ thể khỏe thì não bộ mới khỏe"</strong>.
                    </p>

                    <a href="https://www.facebook.com/groups/tukylaroiloantoanthan" target="_blank" rel="noopener noreferrer" class="w-full flex items-center justify-center gap-2 bg-secondary hover:bg-[#d94f00] text-white font-bold py-3 px-6 rounded-xl transition-all shadow-md hover:shadow-lg">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-6 text-xs text-white/50 text-center lg:text-left">
                <div class="max-w-4xl">
                    <p class="font-bold text-white/70 mb-2 flex items-center justify-center lg:justify-start gap-1">
                        <i data-lucide="alert-triangle" class="w-4 h-4 text-secondary"></i> LƯU Ý QUAN TRỌNG:
                    </p>
