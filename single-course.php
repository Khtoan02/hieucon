                ...
                <div class="sticky top-8 lg:sticky lg:top-[108px] bg-white/85 backdrop-blur-xl border border-white/80 p-6 md:p-8 rounded-[2.5rem] shadow-soft hover:shadow-elegant transition-all duration-500 space-y-6 animate-fadeIn">
                    ...
                    <div class="pt-4 border-t border-slate-100 space-y-3">
                        ...
                        <?php else : ?>
                            ...
                            <?php endif; ?>
                            <?php if ( $current_member && ! $is_enrolled ) : ?>
...
<?php if ( $current_member && ! $is_enrolled ) : ?>
    ...
    <div id="referral-code-modal" class="fixed inset-0 bg-slate-950/65 backdrop-blur-md z-[9999] flex items-center justify-center p-4 opacity-0 pointer-events-none transition-all duration-300">
        <div class="bg-white/95 backdrop-blur-2xl rounded-[2.5rem] border border-orange-200/50 p-6 md:p-10 max-w-md w-full text-center shadow-[0_25px_60px_-15px_rgba(10,25,49,0.18)] relative transform translate-y-8 transition-all duration-300">
            ...
            <p class="text-xs md:text-sm text-slate-500 font-semibold mb-8 px-2">Bạn có mã giới thiệu hoặc mã kích hoạt? Nhập mã vào đây để nhận ưu đãi giảm giá hoặc mở khóa miễn phí khóa học này.</p>
    ...
    <script>
        ...
        async function submitReferralCode(e) {
            ...
            formData.append('post_type', 'course');
