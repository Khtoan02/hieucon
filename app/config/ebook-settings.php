...
function hieucon_ebook_register_cpts()
{
    ...
    // B. Đăng ký CPT: Ebook (ebook) - Thay đổi nhãn thành Cẩm nang
    $ebook_labels = [
        'name' => 'Cẩm nang',
        'singular_name' => 'Cẩm nang',
        'menu_name' => 'Cẩm nang',
        'name_admin_bar' => 'Cẩm nang',
...
function hieucon_ebook_metabox_html($post)
{
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="number" id="ebook_price" name="ebook_price" value="<?php echo esc_attr($price); ?>"
                    class="regular-text" placeholder="Ví dụ: 200000. Để trống hoặc 0 nếu Miễn phí.">
            </td>
        </tr>
        <tr>
            <th><label for="ebook_pdf_url">Đường dẫn tệp PDF gốc</label></th>
            <td>
                <input type="text" id="ebook_pdf_url" name="ebook_pdf_url" value="<?php echo esc_attr($pdf_url); ?>"
                    class="large-text" placeholder="Tải lên thư viện Media và dán link file .pdf vào đây">
        ...
        <tr>
            ...
            <td>
                <input type="number" id="ebook_pages" name="ebook_pages" value="<?php echo esc_attr($pages); ?>"
                    class="regular-text" placeholder="Ví dụ: 120" min="1">
            </td>
        </tr>
        <tr>
            <th><label for="ebook_sample_url">Tệp đọc thử (PDF trích dẫn - Optional)</label></th>
            <td>
                <input type="text" id="ebook_sample_url" name="ebook_sample_url"
                    value="<?php echo esc_attr($sample_url); ?>" class="large-text"
                    placeholder="Link PDF đọc thử (ví dụ: 10 trang đầu)">
            </td>
        </tr>
    </table>
