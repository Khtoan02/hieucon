...
<body class="bg-healing-gradient text-navy antialiased selection:bg-secondary/30 selection:text-navy min-h-screen flex flex-col justify-between">
    <?php wp_body_open(); ?>

    <main class="flex-grow flex items-center justify-center py-16 px-4 relative z-10">
        <div class="max-w-3xl w-full mx-auto text-center glass-card p-10 md:p-16 rounded-[3rem] shadow-elegant relative overflow-hidden">
            ...
            <h1 class="font-serif text-5xl md:text-7xl font-extrabold text-navy/10 mb-2 tracking-widest absolute top-8 left-1/2 -translate-x-1/2 pointer-events-none">404</h1>
            ...
            <p class="text-base md:text-xl text-navy/80 font-medium mb-12 max-w-xl mx-auto leading-relaxed relative z-10">
                Đường dẫn có thể đã bị thay đổi hoặc không chính xác. Tuy nhiên, mái nhà chung <strong class="text-navy">Hiểu Con Từ Gốc - Tự Kỷ Là Rối Loạn Toàn Thân</strong> vẫn luôn ở ngay đây chờ đón ba mẹ.
            </p>

            <div class="flex flex-col sm:flex-row gap-5 justify-center items-center relative z-10">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="w-full sm:w-auto bg-navy hover:bg-navy-light text-white px-8 py-3.5 md:py-4 rounded-full font-bold transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-3">
    ...
    <footer class="border-t border-white/30 bg-white/20 backdrop-blur-md py-6">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-center items-center gap-2">
                <span class="font-serif italic text-navy/70 text-sm md:text-base">"Hiểu con từ gốc, yêu thương trọn vẹn."</span>
            </div>
        </div>
    </footer>
